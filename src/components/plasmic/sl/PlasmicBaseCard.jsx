...
import sty from "./PlasmicBaseCard.module.css"; // plasmic-import: FN8Rw6f3XUITve/css
...
function PlasmicBaseCard__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__iXtBj, {
          [sty.freeBoxlong__iXtBjW8Mz]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant(variants, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__hgZDn, {
            [sty.freeBoxlong__hgZDnW8Mz]: hasVariant(variants, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__qxBwr)}
                role={"img"}
              />
            ),

...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: Uhbyt3wOu41kKj/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___0HbDw)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__luTzD)}>
          <div className={classNames(projectcss.all, sty.freeBox__yfGWr)}>
            {p.renderPlasmicSlot({

...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: KimUJiQAEnND26/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: kiMQmbRrNSOgLL/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: S4e2i6oZGdxHc7/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__sl5Aq)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__ncZ2E)}
                role={"img"}
              />
            ),
